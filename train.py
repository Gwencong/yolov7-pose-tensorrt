...
if __name__ == '__main__':
    ...
    parser.add_argument('--kpt-label', action='store_true',default=True, help='use keypoint labels for training')
    parser.add_argument('--freeze', type=int, default=46, help='Number of layers to freeze. backbone=10, all=24')
