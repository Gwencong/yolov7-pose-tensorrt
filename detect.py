...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='/home/gwc/gwc/code/yolo-pose-tensorrt/data/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--img-size', nargs= '+', type=int, default=832, help='inference size (pixels)')
